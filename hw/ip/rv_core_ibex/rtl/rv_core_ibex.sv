...
`endif
  ...
  alert_event_t fatal_intg_event;
  alert_event_t fatal_core_event;
  alert_event_t recov_core_event;
  assign fatal_intg_event = (ibus_intg_err | dbus_intg_err) ? EventOn : EventOff;
  assign fatal_core_event = alert_major ? EventOn : EventOff;
  assign recov_core_event = alert_minor ? EventOn : EventOff;
...
`endif
  ...
  assign fatal_intg_err = fatal_intg_event != EventOff;
  assign fatal_core_err = fatal_core_event != EventOff;
  assign recov_core_err = recov_core_event != EventOff;
